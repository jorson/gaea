...
import gaea.foundation.core.utils.object.JsonObject;
 ...
 * @author wuhy
 */
public class ObjectUtilsJsonTest {
    ...
    public void testSimpleToJson() {
        ...
        Assert.assertEquals("转换简单类(Date)的对象，返回值与比较值不一致", ObjectUtils.toJson(array), "[\"" + strDate + "\",\"" + strDate + "\",\"" + strDate + "\"]");
        // 嵌套对象转换
        // 复杂对象转换
    }
...
//       / System.out.println(ObjectUtils.toJson(map));
    ...
    @Test
    public void testEnumObjectToFromJson() {
        JsonObject jsonObject = new JsonObject();
//        jsonObject.setEnumObject(EnumObject.INT);
        String jsonStr = ObjectUtils.toJson(jsonObject);
        JsonObject ret = ObjectUtils.fromJson(jsonStr, JsonObject.class);
        jsonStr = "{\"id\":0,\"enumObject\":\"int\"}";
        ret = ObjectUtils.fromJson(jsonStr, JsonObject.class);
        System.out.println(jsonStr);
    }
    ...
    public void testCustomDateTimeFromToJson() {
        ...
        //com.huayu.foundation.core.type.StrictDate customDate = new com.huayu.foundation.core.type.StrictDate(normalDate);
