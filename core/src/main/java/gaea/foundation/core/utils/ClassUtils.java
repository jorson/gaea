...
public class ClassUtils extends org.springframework.util.ClassUtils {
     ...
     * @param clazz 类
     * @return 对象
     * @throws com.huayu.foundation.core.exception.BaseRuntimeException 如果没有创建成功，则抛出异常
     */
    ...
    /**
     * 先取得外部插件的Class Loader，如果没有开启外部插件，
     * 则直接使用当前线程的Class Loader
     *
     * @return Class Loader
     */
//    public static ClassLoader getExtClassLoader() {
//        if (SystemConfig.Instance.getBooleanProperty(AframeConstant.SYSTEM_PLUGINS_EXT_ENABLED)) {
//            if (clazzLoader == null) {
//                String extPath = SystemConfig.Instance.getProperty(AframeConstant.SYSTEM_PLUGINS_EXT_CLASSPATH, "");
...
//                                logger.debug("Append ClassPath:" + urls[i]);
//                            }
//                        }
//                        ClassLoader pcl = Thread.currentThread().getContextClassLoader();
//                        clazzLoader = new URLClassLoader(urls, pcl);
