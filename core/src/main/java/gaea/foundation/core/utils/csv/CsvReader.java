 ...
 */
package gaea.foundation.core.utils.csv;
...
public class CsvReader {
    ...
    /**
     * Creates a {@link geaa.foundation.core.utils.csv.CsvReader CsvReader} object using a file
     * as the data source.
     *
    ...
    /**
     * Constructs a {@link geaa.foundation.core.utils.csv.CsvReader CsvReader} object using a
    ...
    /**
     * Constructs a {@link geaa.foundation.core.utils.csv.CsvReader CsvReader} object using an
     ...
     * {@link geaa.foundation.core.utils.csv.CsvReader#readHeaders readHeaders()}.
     *
    ...
    /**
     * Creates a {@link geaa.foundation.core.utils.csv.CsvReader CsvReader} object using a string
     * of data as the source.&nbsp;Uses ISO-8859-1 as the
     * {@link java.nio.charset.Charset Charset}.
     *
     * @param data The String of data to use as the source.
     * @return A {@link geaa.foundation.core.utils.csv.CsvReader CsvReader} object using the
     ...
     * increment
     * {@link geaa.foundation.core.utils.csv.CsvReader#getCurrentRecord getCurrentRecord()}.
     *
