...
public class GenericsUtils {
    ...
    private final static Log LOGGER = LogFactory.getLog(GenericsUtils.class);
    ...
    public static Type[] getFieldGenericTypes(Field field) {
        ...
        if (!(genericFieldType instanceof ParameterizedType)) {
            LOGGER.warn(field.getName() + "'s superclass not ParameterizedType");
            return new Type[0];
        }
    ...
    public static Class getFieldGenericType(Field field, int index) {
        ...
        if (genericFieldType instanceof ParameterizedType) {
            ...
            if (index >= fieldArgTypes.length || index < 0) {
                LOGGER.warn("Index: " + index + ", Size of " + field.getName() + "'s Parameterized Type: " + fieldArgTypes.length);
                return Object.class;
            }
