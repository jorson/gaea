...
public class BeanUtils {
    ...
    public static Object forceGetProperty(Object object, String propertyName) throws NoSuchFieldException {
        ...
        try {
            ...
            LOGGER.info("error wont' happen", e);
        }
    ...
    public static void forceSetProperty(Object object, String propertyName, Object newValue) throws NoSuchFieldException {
        ...
        try {
            ...
            LOGGER.info("Error won't happen", e);
        }
        field.setAccessible(accessible);
    }
     ...
     * @throws NoSuchMethodException 如果没有该Method时抛出.
     */
    public static Object forceInvokeMethod(Object object, Method method, Object... params) throws NoSuchMethodException {
        Assert.notNull(object);
     ...
     * @throws java.lang.reflect.InvocationTargetException if the property accessor method
     *                                                     throws an exception
            ...
            for (Class superClass = bean.getClass(); superClass != Object.class; superClass = superClass.getSuperclass()) {
                ...
                for (int i = 0; i < fields.length; i++) {
                    ...
                    if ((value != null || nullable) && !Modifier.isStatic(field.getModifiers()) || Modifier.isTransient(field.getModifiers())) {
                        String key = isPascal ? StringUtils.toUpperFirstLetter(field.getName()) : field.getName();
